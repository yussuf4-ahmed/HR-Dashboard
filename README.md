...
The dataset was **synthetically generated using the Python Faker library**, ensuring realistic yet privacy-safe data for analysis.  
**Tableau** was used for dashboard development and visualization to create a dynamic, insightful, and interactive experience.
...
The objective was to build **centralized dashboards** that simplify performance tracking, identify bottlenecks, and reveal patterns across both sales and workforce data.
